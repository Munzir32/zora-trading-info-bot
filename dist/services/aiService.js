...
export const createAIService = (apiKey) => {
    const openai = new OpenAI({
        apiKey,
    });
    return {
        analyzeMarketData: async (coin, marketData) => {
            try {
        ...
        generateTradingSignals: async (coin, historicalData) => {
            try {
        ...
        analyzePortfolio: async (portfolio) => {
            try {
